...
cd ('/media/jdmccart/Icculus/EyeHandPrimingMRI/MatlabData/');
%subFiles = dir('M*');
...
for subNum = 1:length(subList)
    ...
    mkdir(strcat('/media/jdmccart/Icculus/EyeHandPrimingMRI/DataMRI/Sub',num2str(subList(subNum)),'/StimTimes'));
    movefile('*.txt',strcat('/media/jdmccart/Icculus/EyeHandPrimingMRI/DataMRI/Sub',num2str(subList(subNum)),'/StimTimes'))
